...
// --- UI Components ---
import Button from "../components/Button"; // Importation relative du composant Button
...
const CalculatorSection = ({ 
    ...
    const [formData, setFormData] = useState({
        ...
        insulation: "bonne",
        department: "placeholder", // Utilisation de 'placeholder'
        reversible: true,
        wifi: false,
        inverter: true,
        installation: true,
    ...
    const calculateEstimate = () => {
        ...
        setTimeout(() => {
            ...
            const results: CalculationData = {
                ...formData,
                selectedInstallationType,
                surface, rooms, income, householdSize: parseInt(formData.householdSize),
...
const ContactSection = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        contactPhone: "",
        contactEmail: "",
        contactDepartment: "placeholder", // Utilisation de 'placeholder'
        contactMessage: "",
...
const QuickContactModal = ({ isOpen, onClose, calculationData }: { isOpen: boolean, onClose: () => void, calculationData: CalculationData | null }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        phone: "",
        email: "",
        department: calculationData?.department || "placeholder", // Utilisation de 'placeholder'
        consent: false,
    });
